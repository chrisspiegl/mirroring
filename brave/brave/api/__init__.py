...
class RestApi(object):
    ...
    def __init__(self, session):
        ...
        # CUSTOM MIRRORING COMMANDS START
        app.add_route(route_handler.fade, "/api/fade")
        # app.add_route(route_handler.textCenter, "/api/text-center")
        # CUSTOM MIRRORING COMMANDS END
