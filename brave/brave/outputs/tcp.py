...
class TCPOutput(Output):
    ...
    def create_elements(self):
        ...
        if config.enable_video():
            ...
            self.pipeline.get_by_name('encoder').set_property('bitrate', 4500)
            self.pipeline.get_by_name('encoder').set_property('pass', 'cbr')
            self.pipeline.get_by_name('encoder').set_property('speed-preset', 'ultrafast')
